      ...
      {!hasPlans ? (
        <section className="rounded-xl border border-dashed p-8 text-center">
          ...
          <div className="mt-4">
            <Link
              href="/plan/new"
              className="inline-flex items-center justify-center whitespace-nowrap rounded-md bg-[#1E3A8A] px-4 py-2 text-sm font-bold text-white hover:bg-blue-800"
            >
              備えプランを作る
            </Link>
          </div>
            ...
            <article key={plan.id} className="rounded-xl border p-5 shadow-sm">
              ...
              <div className="mt-4 flex gap-2">
                ...
                <button
                  ...
                  className="inline-flex items-center justify-center whitespace-nowrap rounded-md border border-red-300 px-4 py-2 text-sm font-bold text-red-600 hover:bg-red-50"
                >
                  削除
                </button>
              </div>
