    ...
    <main className="mx-auto max-w-5xl p-6">
      ...
      <div className="mb-6 grid gap-4 sm:grid-cols-2">
        <section className="rounded-xl border border-blue-200 bg-blue-50 p-5">
          <h2 className="text-lg font-semibold text-[#1E3A8A]">初期費用</h2>
            ...
            <article key={item.id} className="flex flex-col gap-4 rounded-lg border p-4">
              ...
              <div className="flex flex-wrap gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex min-w-[120px] items-center justify-center whitespace-nowrap rounded-md bg-[#1E3A8A] px-4 py-2 text-sm font-bold text-white hover:bg-blue-800"
                >
                  商品を見る
                </a>
                <Link
                  href="/stock-items"
                  className="inline-flex min-w-[120px] items-center justify-center whitespace-nowrap rounded-md border px-4 py-2 text-sm font-bold text-gray-700 hover:bg-gray-100"
                >
                  備蓄登録
                </Link>
              </div>
      ...
      <div className="flex flex-wrap gap-3">
        ...
        <button
          ...
          className="rounded-md border border-red-300 px-4 py-2 text-sm font-bold text-red-600 hover:bg-red-50"
        >
          削除
        </button>
      </div>
